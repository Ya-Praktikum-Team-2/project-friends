...
buttonCards.addEventListener('click', () => {
    cardBox.classList.add('card__box_opened');
...
function closeCard(cards) {
    cards.classList.remove('card__box_opened');
}
...
//Оражение в "Итого к оплате"  суммы, напечатанной в поле "Другая сумма"
const inputOtherAmount = document.querySelector('input[id="other-amount"]');

inputOtherAmount.oninput = function () {
